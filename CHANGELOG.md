...
### Fixed
* Fixed an issue where materials with fresnel blending would not render correctly in Cycles.
...
* Fixed an issue where wimdo export would not use correct default values for vector attributes in some cases.
